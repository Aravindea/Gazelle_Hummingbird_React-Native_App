...
const CONFIRMPATIENTINFO = () => {
  return (
    <View style={[styles.confirmPatientInfo, styles.pageTitleBarFlexBox]}>
      <View style={styles.confirmPatientInfoContainer}>
        <View style={styles.confirmPatientInfoSection}>
          <View style={styles.topBar}>
            ...
            <View style={[styles.pageTitleBar, styles.barFlexBox]}>
              ...
              <Text style={styles.confirmPatientInfo1}>
                CONFIRM PATIENT INFO
              </Text>
            </View>
          </View>
          <View style={[styles.confirmPatientInfo2, styles.confirmLayout]}>
            <View style={styles.confirmPatientInfoCard}>
