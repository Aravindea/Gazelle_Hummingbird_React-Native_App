...
const MIXBLOODANDMARKERFLUIDA = () => {
  return (
    <View style={styles.mixBloodAndMarkerFluidA}>
      <View style={styles.mixBloodAndMarkerFluidAC}>
        <View style={styles.mixBloodAndMarkerFluidAS}>
          ...
          <View style={[styles.mixBloodAndMarkerFluidA1, styles.mixSpaceBlock]}>
            <View
              style={[styles.mixBloodAndMarkerFluidAD, styles.mixSpaceBlock]}
            >
              <Image
                style={styles.mixBloodAndMarkerFluidAV}
                resizeMode="cover"
                source={require("../assets/mix-blood-and-marker-fluid-a-video-gif.png")}
              />
...
const styles = StyleSheet.create({
  ...
  mixBloodAndMarkerFluidAD: {
    alignSelf: "stretch",
  },
  mixBloodAndMarkerFluidA1: {
    paddingHorizontal: Padding.p_11xl,
    maxWidth: 500,
    marginTop: 40,
    width: "100%",
  },
  mixBloodAndMarkerFluidAS: {
    alignItems: "center",
    alignSelf: "stretch",
    flex: 1,
  },
  ...
  mixBloodAndMarkerFluidAC: {
    paddingBottom: Padding.p_11xl,
    alignItems: "center",
    alignSelf: "stretch",
    flex: 1,
  },
  mixBloodAndMarkerFluidA: {
