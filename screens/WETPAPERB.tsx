...
const WETPAPERB = () => {
  return (
    <View style={styles.wetPaperB}>
      <View style={styles.wetPaperBContainer}>
        <View style={styles.wetPaperBSection}>
          ...
          <View style={[styles.wetPaperB1, styles.wetSpaceBlock]}>
            <View style={[styles.wetPaperBDiv, styles.wetSpaceBlock]}>
              <Image
                style={styles.wetPaperBVideoGif}
                resizeMode="cover"
                source={require("../assets/wet-paper-b--video-gif.png")}
              />
