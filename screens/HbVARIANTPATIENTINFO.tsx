...
const HbVARIANTPATIENTINFO = () => {
  ...
  return (
    <View style={[styles.hbVariantPatientInfo, styles.patientLayout]}>
      <View style={styles.hbVariantPatientInfoContai}>
        <View style={styles.hbVariantPatientInfoSectio}>
          <View style={styles.topBar}>
            ...
            <View style={[styles.pageTitleBar, styles.barFlexBox]}>
              ...
              <Text style={styles.hbVariantPatient}>
                Hb VARIANT PATIENT INFO
              </Text>
            </View>
          </View>
          <View style={[styles.patientInfo, styles.patientLayout]}>
            <View style={styles.topBar}>
              ...
              <View style={styles.infantRadio}>
                ...
                <View style={[styles.infantRadio1, styles.age2FlexBox]}>
                  <View style={styles.infantRadioYesNo}>
                    <View
                      style={styles.yes}
                      value={yesValue}
              ...
              <View style={styles.infantRadio}>
                ...
                <View style={[styles.infantRadio1, styles.age2FlexBox]}>
                  <View style={styles.genderRadio1}>
                    <View
                      style={styles.yes}
                      value={maleValue}
